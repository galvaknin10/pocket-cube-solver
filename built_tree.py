...
def bfs_tree_build(solved_cube):
    ...
    Parameters:
    - solved_cube: The solved state of the cube. The cube is expected to have the following methods:
        - hash_rep(): Provides a unique hashable representation of the cube state.
        - copy(): Returns a deep copy of the cube object.
        - action_n(): Performs an action (rotation) on the cube, where 'n' is an integer from 1 to 6.
        - normalize_cube_by_symmetry(): Returns a list of all symmetrical equivalents of the cube state.
        - which_action(): Returns a string describing the action performed on the cube.
